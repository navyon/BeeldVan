...
package com.ngagemedia.beeldvan.crop;
...
//                    mResizeDrawableWidth.setBounds(mDrawRect.left - widthWidth,
//                            mDrawRect.top - widthHeight,
//                            mDrawRect.left + widthWidth,
//                            mDrawRect.top +widthHeight);
...
//                    mResizeDrawableHeight.draw(canvas);
    ...
    public void setup(Matrix m, Rect imageRect, RectF cropRect, boolean circle,
        ...
        mFocusPaint.setARGB(160, 50, 50, 50);
        mNoFocusPaint.setARGB(160, 50, 50, 50);
    ...
    private final Paint mCropCirclePaint = new Paint();
}
